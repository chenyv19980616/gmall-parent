...
public class SkuInfoServiceImpl extends ServiceImpl<SkuInfoMapper, SkuInfo>
    ...
    public Goods getGoodsBySkuId(Long skuId) {
        ...
        CategoryViewTo categoryView = baseCategory1Mapper.getCategoryView(category3Id);
        ...
        //查当前sku的所有平台属性名和值
        List<SearchAttr> attrs = skuAttrValueService.getAttrNameAndValue(skuId);
